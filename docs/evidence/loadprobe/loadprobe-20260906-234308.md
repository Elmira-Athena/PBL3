...
- **Thời điểm chạy:** 2026-09-06 23:43:08 (giờ máy)
...
| S03 | Cùng một khách, MaxUsesPerUser = 1, 10 request | COUNT(VoucherUsages WHERE UserId = khách AND VoucherId = voucher) = 1 | 200×1, 400×2, 409×7 | ✅ ĐẠT |
...
- Phiếu chưa đóng cho serial: 1 (ST-20260906-001030)
- Mã HTTP: 200×10
...
- Cửa sổ đo: mốc 2026-09-06 16:45:00Z, dài 60s, hạn mức 5
...
```
```json
{"success":false,"message":"Tài khoản hoặc mật khẩu không đúng.","data":null}
```
```json
{"success":false,"message":"B\u1EA1n thao t\u00E1c qu\u00E1 nhanh. Vui l\u00F2ng ch\u1EDD trong gi\u00E2y l\u00E1t r\u1ED3i th\u1EED l\u1EA1i."}
```
