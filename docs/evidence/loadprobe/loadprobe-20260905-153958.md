...
- **Thời điểm chạy:** 2026-09-05 15:39:58 (giờ máy)
...
| S03 | Cùng một khách, MaxUsesPerUser = 1, 10 request | COUNT(VoucherUsages WHERE UserId = khách AND VoucherId = voucher) = 1 | 200×1, 400×6, 409×3 | ✅ ĐẠT |
...
- Phiếu chưa đóng cho serial: 1 (ST-20260905-001023)
- Mã HTTP: 200×10
