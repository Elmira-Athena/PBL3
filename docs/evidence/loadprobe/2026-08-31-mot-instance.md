...
- **Thời điểm chạy:** 2026-08-31 16:48:06 (giờ máy)
...
|---|---|---|---|---|
| S01 | 50 khách checkout đồng thời | Không có OrderCode trùng, đủ 50 đơn, 0 lỗi 5xx | 200×9, 400×41 | 🔴 HỎNG |
...
**Kết luận:** 🔴 HỎNG — Chỉ tạo được 9/50 đơn.

- Đơn tạo được: 9/50
- Mã đơn phân biệt: 9
- Mã HTTP: 200×9, 400×41
