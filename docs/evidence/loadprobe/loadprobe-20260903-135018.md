...
- **Thời điểm chạy:** 2026-09-03 13:50:18 (giờ máy)
...
| S03 | Cùng một khách, MaxUsesPerUser = 1, 10 request | COUNT(VoucherUsages WHERE UserId = khách AND VoucherId = voucher) = 1 | 200×1, 400×3, 409×6 | ✅ ĐẠT |
...
- Phiếu chưa đóng cho serial: 1 (ST-20260903-001111)
- Mã HTTP: 200×10
